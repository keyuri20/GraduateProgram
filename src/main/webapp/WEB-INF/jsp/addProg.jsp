...
<form action="addProg.html" method="post" >
<tr><td>Program Name:</td><td><input type="text" name="prog_name" class="form-control" placeholder="Enter Program Name" required></td></tr><br>
