...
<form action="addDept.html" method="post" >
<tr><td>Department Name:</td><td><input type="text" name="dept_name" class="form-control" placeholder="Enter Department Name" required></td></tr><br>
<tr><td colspan="2"><input type="submit" name="add" value="Add" class="btn btn-success">
</form>
</table>
